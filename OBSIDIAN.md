...
`src/content/blog/my-new-post/cover.png`
...
第二种写法在 Obsidian 里很方便，但 Astro 博客默认不会直接按你预期发布。

## 写作流程

1. 复制 `obsidian/blog-post-template.md` 作为新文章模板
2. 在 `src/content/blog/你的文章-slug/` 下新建文件夹
3. 把文章保存成 `index.md`
4. 在 Obsidian 里写正文
5. 如果有图片，就放在同一个文件夹里
6. 本地预览时运行 `npm run dev`
...
`src/content/blog/why-i-like-obsidian/index.md`
`src/content/blog/why-i-like-obsidian/cover.png`
`src/content/blog/why-i-like-obsidian/screenshot.png`
