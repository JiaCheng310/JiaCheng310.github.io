...
![[Pasted image 20260609160858.png|400]]
...
```{=html}
<div style="display:flex; gap:1rem; justify-content:center; align-items:flex-start; flex-wrap:wrap; margin:1.2rem 0;">
  <img src="images/ik_transpose.gif" alt="学习率为 0.02 的 Jacobian Transpose IK" style="flex:1 1 320px; max-width:500px; width:100%; height:auto;">
  <img src="images/ik_transpose0.2.gif" alt="学习率为 0.2 的 Jacobian Transpose IK" style="flex:1 1 320px; max-width:400px; width:100%; height:auto;">
</div>
```
